...
public interface MyCustomOrganisationRepository {
    ...
    @io.swagger.v3.oas.annotations.Operation(operationId = "MyCustomOrganisationRepository_findByName", summary = "Custom finder by Name for name.", parameters = { @io.swagger.v3.oas.annotations.Parameter(name = "page", description = "The page number to return.", in = io.swagger.v3.oas.annotations.enums.ParameterIn.QUERY), @io.swagger.v3.oas.annotations.Parameter(name = "size", description = "The page size.", in = io.swagger.v3.oas.annotations.enums.ParameterIn.QUERY), @io.swagger.v3.oas.annotations.Parameter(name = "name", description = "No description", in = io.swagger.v3.oas.annotations.enums.ParameterIn.QUERY) })
