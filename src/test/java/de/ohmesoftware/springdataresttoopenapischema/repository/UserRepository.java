...
public interface UserRepository extends PagingAndSortingRepository<User, String>, QuerydslPredicateExecutor<User>, CustomUserRepository {
    ...
    @javax.ws.rs.Path("/{id}")
    @javax.ws.rs.DELETE()
    @io.swagger.v3.oas.annotations.Operation(summary = "Deletes a(n) User by its id.", responses = { @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "204", description = "No Content.") })
