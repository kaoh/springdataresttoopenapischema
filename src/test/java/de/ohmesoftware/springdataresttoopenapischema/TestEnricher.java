...
public class TestEnricher {
    ...
    public void testFindersEnrich() throws Exception {
        ...
        assertTrue(newContent.contains("responses = { @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = \"200\", description = \"Paged view with list of: A user being able to log-in.\", content = { @io.swagger.v3.oas.annotations.media.Content(mediaType = \"application/json;charset=UTF-8\", schema = @io.swagger.v3.oas.annotations.media.Schema(ref = \"#/components/schemas/PageUser\")), @io.swagger.v3.oas.annotations.media.Content(mediaType = \"application/hal+json;charset=UTF-8\", schema = @io.swagger.v3.oas.annotations.media.Schema(ref = \"#/components/schemas/PageUser\")) }) }"));
        ...
        assertTrue(newContent.contains("@javax.ws.rs.GET"));
        assertTrue(newContent.contains("@io.swagger.v3.oas.annotations.Parameter(name = \"emailAddress\", description = \"emailAddress search criteria. Used in SQL like fashion. Syntax: emailAddress=value\", in = io.swagger.v3.oas.annotations.enums.ParameterIn.QUERY)"));
        assertTrue(newContent.contains("@io.swagger.v3.oas.annotations.Parameter(name = \"sort\", description = \"The sorting criteria(s). Can be passed multiple times as query with descending priority. Syntax: sort=(username or emailAddress or role or firstName or lastName or blocked or failedLoginAttempts or organisation.* or id or creationDate),(asc or desc)\", in = io.swagger.v3.oas.annotations.enums.ParameterIn.QUERY)"));
    ...
    public void testCustomFinderPageReturned() throws Exception {
        ...
        enricher.enrich();
        String newContent = IOUtils.toString(new FileReader(new File(buildPath(OrganisationRepository.class.getName()) + ".java")));
        assertTrue(newContent.contains("@io.swagger.v3.oas.annotations.Operation(operationId = \"OrganisationRepository_findByNameContaining\", summary = \"Custom finder by NameContaining for name.\", parameters = { @io.swagger.v3.oas.annotations.Parameter(name = \"sort\", description = \"The sorting criteria(s). Can be passed multiple times as query with descending priority. Syntax: sort=(name or foo or id or creationDate),(asc or desc)\", in = io.swagger.v3.oas.annotations.enums.ParameterIn.QUERY), @io.swagger.v3.oas.annotations.Parameter(name = \"page\", description = \"The page number to return.\", in = io.swagger.v3.oas.annotations.enums.ParameterIn.QUERY), @io.swagger.v3.oas.annotations.Parameter(name = \"size\", description = \"The page size.\", in = io.swagger.v3.oas.annotations.enums.ParameterIn.QUERY), @io.swagger.v3.oas.annotations.Parameter(name = \"name\", description = \"No description\", in = io.swagger.v3.oas.annotations.enums.ParameterIn.QUERY) })"));
