...
public interface UserRepository extends PagingAndSortingRepository<User, String>, QuerydslPredicateExecutor<User>, CustomUserRepository {
    ...
    @javax.ws.rs.GET()
    @io.swagger.v3.oas.annotations.Operation(operationId = "UserRepository_findAll", summary = "Finds all Users and returns the result paginated.", parameters = { @io.swagger.v3.oas.annotations.Parameter(name = "username", description = "username search criteria. Syntax: username='value'", in = io.swagger.v3.oas.annotations.enums.ParameterIn.QUERY), @io.swagger.v3.oas.annotations.Parameter(name = "emailAddress", description = "emailAddress search criteria. Syntax: emailAddress='value'", in = io.swagger.v3.oas.annotations.enums.ParameterIn.QUERY), @io.swagger.v3.oas.annotations.Parameter(name = "role", description = "role search criteria. Syntax: role='value'", in = io.swagger.v3.oas.annotations.enums.ParameterIn.QUERY), @io.swagger.v3.oas.annotations.Parameter(name = "firstName", description = "firstName search criteria. Syntax: firstName='value'", in = io.swagger.v3.oas.annotations.enums.ParameterIn.QUERY), @io.swagger.v3.oas.annotations.Parameter(name = "lastName", description = "lastName search criteria. Syntax: lastName='value'", in = io.swagger.v3.oas.annotations.enums.ParameterIn.QUERY), @io.swagger.v3.oas.annotations.Parameter(name = "blocked", description = "blocked search criteria. Syntax: blocked='value'", in = io.swagger.v3.oas.annotations.enums.ParameterIn.QUERY), @io.swagger.v3.oas.annotations.Parameter(name = "failedLoginAttempts", description = "failedLoginAttempts search criteria. Syntax: failedLoginAttempts='value'", in = io.swagger.v3.oas.annotations.enums.ParameterIn.QUERY), @io.swagger.v3.oas.annotations.Parameter(name = "organisation.*", description = "organisation.* search criteria. Syntax: organisation.*='value'", in = io.swagger.v3.oas.annotations.enums.ParameterIn.QUERY), @io.swagger.v3.oas.annotations.Parameter(name = "id", description = "id search criteria. Syntax: id='value'", in = io.swagger.v3.oas.annotations.enums.ParameterIn.QUERY), @io.swagger.v3.oas.annotations.Parameter(name = "creationDate", description = "creationDate search criteria. Syntax: creationDate='value'", in = io.swagger.v3.oas.annotations.enums.ParameterIn.QUERY), @io.swagger.v3.oas.annotations.Parameter(name = "sort", description = "The sorting criteria(s). Syntax: (sort=(username : emailAddress : role : firstName : lastName : blocked : failedLoginAttempts : organisation.* : id : creationDate),(asc : desc))*", in = io.swagger.v3.oas.annotations.enums.ParameterIn.QUERY), @io.swagger.v3.oas.annotations.Parameter(name = "page", description = "The page number to return.", in = io.swagger.v3.oas.annotations.enums.ParameterIn.QUERY), @io.swagger.v3.oas.annotations.Parameter(name = "size", description = "The page size.", in = io.swagger.v3.oas.annotations.enums.ParameterIn.QUERY) }, responses = { @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Paged view with list of: A user being able to log-in.", content = { @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json;charset=UTF-8", schema = @io.swagger.v3.oas.annotations.media.Schema(ref = "#/components/schemas/PageUser")), @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/hal+json;charset=UTF-8", schema = @io.swagger.v3.oas.annotations.media.Schema(ref = "#/components/schemas/PageUser")) }) })
