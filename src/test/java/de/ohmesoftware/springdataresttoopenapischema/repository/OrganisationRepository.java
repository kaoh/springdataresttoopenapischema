...
public interface OrganisationRepository extends MiddleRepository<Organisation>, MyCustomOrganisationRepository {
    ...
    @javax.ws.rs.Path("/{id}")
    @javax.ws.rs.DELETE()
    @io.swagger.v3.oas.annotations.Operation(summary = "Deletes a Organisation by its id.", responses = { @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "204", description = "No Content.") })
