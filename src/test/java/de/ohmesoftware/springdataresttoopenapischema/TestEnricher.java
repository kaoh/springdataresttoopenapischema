...
public class TestEnricher {
    ...
    public void testFindersEnrich() throws Exception {
        ...
        assertTrue(newContent.contains("@io.swagger.v3.oas.annotations.Parameter(name = \"sort\", description = \"The sorting criteria(s). Syntax: (sort=(username : emailAddress : role : firstName : lastName : blocked : failedLoginAttempts : organisation.* : id : creationDate),(asc : desc))*\", in = io.swagger.v3.oas.annotations.enums.ParameterIn.QUERY)"));
